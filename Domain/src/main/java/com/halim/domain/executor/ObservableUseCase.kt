...
//    abstract fun buildUseCaseObservable(params: GetWeatherUsecase.Params?=null): Observable<List<WeatherDetails>>
//
//    open fun getObservable(
//        observer: DisposableObserver<T>,
//        params: GetWeatherUsecase.Params?=null) {
